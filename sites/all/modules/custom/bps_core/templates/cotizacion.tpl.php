	...
	<body>
		...
		<table cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing=0;">
			...
			<tbody>
				...
				<tr>
						<td style="width:200px;text-align:left;font-size:13px;">Tiempo de entrega:</td>
						<td style="width:400px;text-align:left;font-size:13px;"><?php print $time; ?></td>
				</tr>
				<tr>
						<td style="width:200px;text-align:left;font-size:13px;">Validez de la oferta:</td>
						<td style="width:400px;text-align:left;font-size:13px;"><?php print $validity; ?></td>
				</tr>
				<tr>
						<th style="width:200px;text-align:left;font-size:13px;">Garantia:</td>
